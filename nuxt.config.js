...
export default {
  ...
  generate: {
    ...
    return axios.all([
      axios.get('https://spreadsheets.google.com/feeds/list/1rTyfInS6NjTifbru61mWEqICyv9uuMVSSk7NZTABLQc/3/public/values?alt=json'), // events
  ...
  */
  head: {
	...
	meta: [
		...
		{ hid: 'twitter:image', property: 'twitter:image', content: "https://citylab-berlin.org/images/social-graph.jpg" },
	],
	script: [
	...
	[
	  ...
	  imports: [
		...
		// you must have it in your node_modules to actually import
		{
		  ...
		  icons: ['faEnvelope', 'faBicycle', 'faNewspaper', 'faStamp', 'faUserSecret', 'faGenderless', 'faGlobeEurope', 'faInfo', 'faUsers']
		}
	  ]
	}]
  ],
