  ...
  import Matomo from '../../components/Matomo.vue';
    ...
    head () {
      return {
        ...
        meta: [
          { hid: 'description', name: 'description', content: 'AI-consultation hours (2020-04-08 - CityLAB Berlin)' },
          { hid: 'fb:app_id', property: 'fb:app_id', content: '487094758334595'},
          { hid: 'og:type', property: 'og:type',  content: "website"},
          { hid: 'og:title', property: 'og:title',  content: "AI-consultation hours"},
          { hid: 'og:image', property: 'og:image',  content: "https://citylab-berlin.org/images/events/AIforberlin2_hero.jpg"},
          { hid: 'og:description', property: 'og:description',  content: "AI-consultation hours (2020-03-03 - CityLAB Berlin)"},
          ...
          { hid: 'twitter:title', name: 'twitter:title', content: "AI-consultation hours"},
          { hid: 'twitter:description', name: 'twitter:description', content: "AI-consultation hours (2020-04-08 - CityLAB Berlin)"},
          ...
          { hid: 'description', itemprop: 'description', content: "AI-consultation hours (2020-04-08 - CityLAB Berlin)"},
