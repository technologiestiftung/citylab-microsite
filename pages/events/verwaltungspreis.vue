...
export default {
  ...
  data() {
    return {
      ...
      direct: "/events/verwaltungspreis",
    };
  },
  head() {
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          property: "og:image",
          content:
            "https://citylab-berlin.org/images/events/verwaltungspreis_social_media.jpg",
        },
        {
          hid: "og:description",
        ...
        },
        {
          hid: "twitter:url",
          name: "twitter:url",
          content: "https://www.citylab-berlin.org/events/verwaltungspreis",
        },
        {
          hid: "twitter:title",
          name: "twitter:title",
