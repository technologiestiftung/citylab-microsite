<template>
    <div>
        ...
        <section class="section is-medium">
            <div class="container">
                <h1 class="title" v-html="this.content[this.lang]['register']['errors']['mailalreadyexists']['title']" style="margin-top: 100px"></h1>
                <h2 class="subtitle" v-html="this.content[this.lang]['register']['errors']['mailalreadyexists']['subtitle']"></h2>
                    ...
                    <div class="cr_body cr_page cr_font formbox">
                        <div class="non_sortable" style="text-align:left;"></div>
                            ...
                            <div class="editable_content" style="text-align:left;">
                                <div id="4405745" rel="text" class="cr_ipe_item ui-sortable" style=" margin-bottom:0px;">
                                <label for="text4405745" class="itemname">{{ content[lang]['register']['form']['name'] }}</label> 
                                <input class="input" id="text4405745" name="1090337" type="text" value=""/>
                            </div>
    ...
    export default {
        ...
        data() {
            return {
                content: content,
                lang: 'de',
				direct: '/newsletter_mailalreadyexists_en'
            }
        },
        mounted() {
...
<style lang="scss">
    ...
    .cr_form {
        ...
        .cr_ipe_item select {
            background: none repeat scroll 0 0 #eeeeee;border: 1px solid #aaa;
            display: block;
            margin: 0;
            padding: 5px;
            width: 100%;
