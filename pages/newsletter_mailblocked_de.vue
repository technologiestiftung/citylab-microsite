<template>
    <div>
        ...
        <section class="section is-medium">
            <div class="container">
                <h1 class="title" v-html="this.content[this.lang]['register']['errors']['mailblocked']['title']" style="margin-top: 100px"></h1>

                <h2 class="subtitle" v-html="this.content[this.lang]['register']['errors']['mailblocked']['subtitle']"></h2>
    ...
    export default {
        ...
        data() {
            return {
                content: content,
                lang: 'de',
				direct: '/newsletter_mailblocked_en'
            }
        },
        mounted() {
