export const smartcity = {
  ...
  downloads: {
    title: {
      de: "Antrag herunterladen",
      en: "Download the submission",
    },
    description: {
      en:
        "The application was drafted by a consortium of civil society, business, science and public administration representatives under the leadership of the Berlin Senate Chancellery.",
      de:
    ...
    additional: [
      {
        text: {
          en: "Call for Civil Society Engagement",
          de: "Call for Civil Society Engagement",
        },
        url: "/docs/20210210CallforCivilSoc.pdf",
      },
      {
        text: {
          en: "Submission",
