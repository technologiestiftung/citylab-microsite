...
Wir freuen uns, als CityLAB diesen Prozess aktiv zu begleiten. Gemeinsam mit unserer Community haben wir im letzten Jahr zahlreiche spannende Projekte realisiert und dabei vielfältige Erfahrungen gesammelt, die natürlich in die neue Smart City-Strategie einfließen sollen. Um den ganzen Prozess möglichst transparent und partizipativ zu gestalten, werden wir in den nächsten Monaten verschiedene Beteiligungsformate anbieten. Als ersten Schritt veröffentlichen wir hier die Antragsunterlagen.`,
  ...
  downloads: {
    ...
    description: {
      en:
        "The application was drafted by a consortium of civil society, business, science and administration under the leadership of the Berlin Senate Chancellery.",
      de:
    ...
    additional: [
      {
        text: { en: "additional 1", de: "Anhang 1: Kommunikation" },
        url: "/docs/SC_Kommunikationsstruktur.pdf",
      },
      {
        text: { en: "additional 2", de: "Anhang 2: Raumbezüge " },
        url: "/docs/SC_Raumbezüge.pdf",
      },
      {
        text: { en: "additional 3", de: "Anhang 3: Steuerung" },
        url: "/docs/SC_Steuerung.pdf",
      },
      {
        text: { en: "additional 4", de: "Anhang 4: Vorhaben" },
